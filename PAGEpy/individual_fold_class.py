class IndividualFold:
    ...
    def __init__(self, folds_object, current_fold=0):
        ...
        self.x_train = self.folds_object.x_train_folds[current_fold]
        # Gene expression data for testing
        self.x_test = self.folds_object.x_test_folds[current_fold]
        # Target values for training set
        self.y_train = self.folds_object.y_train_folds[current_fold]
        # Numerical outcomes for testing
        self.y_test = self.folds_object.y_test_folds[current_fold]
