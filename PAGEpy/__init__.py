...
logging.basicConfig(level=logging.INFO, handlers=[handler]) # <-- change this to show/hide debug logs
# Remark: changin it to debug shows log messages from all libraries (it's a mess)
