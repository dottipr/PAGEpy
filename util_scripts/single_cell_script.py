...
from PAGEpy.utils import init_cuda
...
def main():
    ...
    plot_functions.plot_model_history(
        ...
        y_train=current_data.y_train,
        y_test=current_data.y_test,
        save_path="initial_model_history.png"
    )
    ...
    plot_functions.plot_model_history(
        ...
        y_train=y_train,
        y_test=y_test,
        save_path="improved_model_history.png"
    )
